    ...
    <div className="flex flex-col h-full">
      ...
      <Tabs defaultValue="notes" className="flex-1 flex flex-col min-w-0">
        ...
        >
          ...
          <TabsTrigger value="dokumen" className="shrink-0 rounded-md data-[state=active]:bg-background data-[state=active]:text-primary! data-[state=active]:shadow-sm px-3 md:px-4 py-2 text-xs md:text-sm whitespace-nowrap">
            <FileText className="h-3 w-3 md:h-4 md:w-4 mr-1 md:mr-2" />
            Dokumen
          </TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="dokumen" className="flex-1 h-[calc(100vh-[250px])] min-h-0 flex flex-col">
          <DocumentTab noteId={noteId} />
        </TabsContent>
      </Tabs>
